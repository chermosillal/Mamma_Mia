...
const Home = () => {
  return (
      ...
      <div class="productos">
        ...
        <CardPizza img="src/assets/img/napolitana.jpg" name="Napolitana" ingredients={["mozzarella, ", "tomates, ", "jamón, ", "orégano"]} price="5.950"/>
        ...
        <CardPizza img="src/assets/img/espanola.jpg" name="Española" ingredients={["mozzarella ,", "gorgonzola ,", "parmesano ,", "provolone"]} price="6.950"/>
        ...
        <CardPizza img="src/assets/img/peperoni.jpg" name="Pepperoni" ingredients={["mozzarella ,", "pepperoni ,", "orégano"]} price="6.950"/>
      </div>
      </>
  )
}
