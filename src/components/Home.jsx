...
const Home = () => {
  return (
      ...
      <div class="productos">
        ...
        <CardPizza img="public/napolitana.jpg" name="Napolitana" ingredients={["mozzarella", "tomates", "jamón", "orégano"]} price="5950"/>
        ...
        <CardPizza img="public/espanola.jpg" name="Española" ingredients={["mozzarella", "gorgonzola", "parmesano", "provolone"]} price="6950"/>
        ...
        <CardPizza img="public/peperoni.jpg" name="Pepperoni" ingredients={["mozzarella", "pepperoni", "orégano"]} price="6950"/>
      </div>
      </>
  )
}
